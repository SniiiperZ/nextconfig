    ...
    <ActionSection>
        ...
        <template #content>
            <h3
                ...
                class="text-lg font-medium text-led-green"
            >
            ...
            <h3 v-else class="text-lg font-medium text-led-green">
            ...
            <div class="mt-3 max-w-xl text-sm text-white/80">
                <p>
                    ...
                    serez invité à saisir un jeton aléatoire sécurisé lors de
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-white/80">
                        <p v-if="confirming" class="font-semibold text-white">
                            Pour terminer l'activation de l'authentification à
                            deux facteurs, scannez le code QR suivant avec
                        ...
                        <p v-else class="text-white/80">
                            ...
                            activée. Scannez le code QR suivant avec
                            l'application d'authentification de votre téléphone
                            ou entrez la clé de configuration.
                        </p>
                    </div>

                    <div
                        class="mt-4 p-2 inline-block bg-white rounded"
                        v-html="qrCode"
                    />
                    ...
                    <div v-if="setupKey" class="mt-4 max-w-xl text-sm">
                        <p class="font-semibold text-white">
                            ...
                            <span
                                class="text-led-green break-all"
                                v-html="setupKey"
                            ></span>
                        </p>
                    </div>
                ...
                <div v-if="recoveryCodes.length > 0 && !confirming">
                    <div class="mt-4 max-w-xl text-sm text-white">
                        <p class="font-semibold">
                            Conservez ces codes de récupération dans un
                    ...
                    <div
                        class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-deep-black/50 rounded-lg border border-gaming-red/30"
                    >
                        <div
            ...
            <div class="mt-5 space-y-3 sm:flex sm:space-y-0 sm:space-x-3">
                <div v-if="!twoFactorEnabled">
                    <ConfirmsPassword
